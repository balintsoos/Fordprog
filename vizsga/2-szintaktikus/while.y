...
|
	forciklus
	{
		std::cout << "utasitas -> forciklus" << std::endl;
	}
;
...
forciklus:
	...
	{
        std::cout << "forciklus -> FOR AZONOSITO IN kifejezes PONTPONT kifejezes ADDIG utasitasok CIKLUS_VEGE" << std::endl;
	}
;
...
|
	...
	{
		std::cout << "kifejezes -> BALZAROJEL kifejezes KERDOJEL kifejezes KETTOSPONT kifejezes JOBBZAROJEL" << std::endl;
	}
|
